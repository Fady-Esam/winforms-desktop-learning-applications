...
namespace WFs.DevExpressLevel1.TestSpreedSheet {
    ...
    public partial class EmployeesDBDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeesRow AddEmployeesRow(string Name, EmployeesRow parentEmployeesRowByFK_Employees_Employees, decimal Salary) {
                ...
                if ((parentEmployeesRowByFK_Employees_Employees != null)) {
                    columnValuesArray[2] = parentEmployeesRowByFK_Employees_Employees[0];
                }
...
namespace WFs.DevExpressLevel1.TestSpreedSheet.EmployeesDBDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employees] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Name] = @Original_Name) AND ((@IsNull_ManagerID = 1 AND [ManagerID] IS NULL) OR ([ManagerID] = @Original_ManagerID)) AND ((@IsNull_Salary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([Name], [ManagerID], [Salary]) VALUES (@Name, @Man" +
                "agerID, @Salary);\r\nSELECT EmployeeID, Name, ManagerID, Salary FROM Employees WHE" +
                "RE (EmployeeID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [Name] = @Name, [ManagerID] = @ManagerID, [Salary] = @Salary WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Name] = @Original_Name) AND ((@IsNull_ManagerID = 1 AND [ManagerID] IS NULL) OR ([ManagerID] = @Original_ManagerID)) AND ((@IsNull_Salary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)));
SELECT EmployeeID, Name, ManagerID, Salary FROM Employees WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WFs.Properties.Settings.Default.EmployeesDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, Name, ManagerID, Salary FROM dbo.Employees";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_Name, global::System.Nullable<int> Original_ManagerID, global::System.Nullable<decimal> Original_Salary) {
            ...
            if ((Original_ManagerID.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_ManagerID.Value));
            }
            else {
        ...
        public virtual int Insert(string Name, global::System.Nullable<int> ManagerID, global::System.Nullable<decimal> Salary) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, global::System.Nullable<int> ManagerID, global::System.Nullable<decimal> Salary, int Original_EmployeeID, string Original_Name, global::System.Nullable<int> Original_ManagerID, global::System.Nullable<decimal> Original_Salary, int EmployeeID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<int> ManagerID, global::System.Nullable<decimal> Salary, int Original_EmployeeID, string Original_Name, global::System.Nullable<int> Original_ManagerID, global::System.Nullable<decimal> Original_Salary) {
            return this.Update(Name, ManagerID, Salary, Original_EmployeeID, Original_Name, Original_ManagerID, Original_Salary, Original_EmployeeID);
        }
    }
